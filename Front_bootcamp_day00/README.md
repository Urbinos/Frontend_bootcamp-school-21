...
9. [Задание 8.](#задание-8)
10. [Задание 9.](#задание-9)
...
## Задание 6. 
Напиcать функцию, которая принимает индекс числа из ряда Фибоначчи и возвращает его значение \
...
## Задание 9. 
Написать функцию для решения Судоку. Функция принимает один аргумент - строку, в которой на месте пропущенных цифр стоят -.
